...
public class RespondingToHtmlEvents extends Application {
    ...
    @Override public void start(final Stage stage) {
        ...
        final IntegerProperty countDown = new SimpleIntegerProperty(refreshCountdown);
        final ChangeListener refresher = new ChangeListener<Number>() {
        ...
        countDown.addListener(refresher);
        ...
        stage.setOnCloseRequest(new EventHandler<WindowEvent>(){
            public void handle(WindowEvent event){
                timeToRefresh.stop();
                countDown.removeListener(refresher);
